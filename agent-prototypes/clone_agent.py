...
class Agent:
    def __init__(self):
        ...
        self.filename =  datetime.now().strftime('clone_agent/log/log_%H_%M_%d_%m_%Y.csv')
    ...
    def save_action_log(self, step, actions, player_state):
        ...
        with open(self.filename, 'a+', newline = '') as f:
            f.write('Agent ' + str(player_state.id) + ' | Tick: {0} - {1} | Current Score: {2} \n'.format(step, actions, reward))
